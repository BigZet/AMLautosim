...
from src.aml_workshop_simulator.services.aml_game_attribute_features_v1 import FEATURES, views, raw_probabilities, calibrated
...
def train(dataset, output, depth=8, iterations=1400):
    ...
    model = CatBoostClassifier(iterations=iterations, depth=depth, learning_rate=.05, l2_leaf_reg=5,
    ...
    manifest = dict(training_parameters=dict(depth=depth,iterations=iterations,selected_iteration=model.best_iteration_), extractor_version='aml-game-attributes-context-v1', score_kind='educational_pattern_interpretation_probability', architecture='mean_of_three_shared_classifier_views',
                    ...
                    inference_source_sha256=file_hash('src/aml_workshop_simulator/services/aml_game_attribute_features_v1.py'),
...
if __name__ == '__main__':
    ...
    train(args.dataset,args.output,args.depth,args.iterations)

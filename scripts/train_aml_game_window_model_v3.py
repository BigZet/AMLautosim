...
from src.aml_workshop_simulator.services.aml_game_window_model_v2 import FEATURES, views, interpretation_targets, raw_probabilities, calibrated
...
def train(dataset, output):
    ...
    model = CatBoostClassifier(iterations=2600, depth=8, learning_rate=.05, l2_leaf_reg=5,
    ...
    manifest = dict(score_kind='educational_pattern_interpretation_probability', architecture='mean_of_three_shared_classifier_views',
                    ...
                    full_dataset_window_label_equivalence=True, trainer_sha256=file_hash(__file__), trainer_path='scripts/train_aml_game_window_model_v3.py',
                    inference_source_sha256=file_hash('src/aml_workshop_simulator/services/aml_game_window_model_v2.py'),

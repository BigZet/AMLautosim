...
- [План аудита смысла операций и интерфейса](plans/aml-behavior/09-semantic-and-interface-audit.md).
- [Отчёт аудита: 79 сочетаний и диагностика оценок](verification/semantic-interface-audit/README.md).

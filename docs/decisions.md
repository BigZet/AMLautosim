...
`cash_deposit`, `card_transfer`, `cash_withdrawal`. У каждой не более двух
...
неинформативным. Цель раунда в 150 000 ₽ достижима одним переводом, а лимиты ночных,
анонимных и наличных операций остаются проверяемыми на оставшемся наборе.

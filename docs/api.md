...
снимка: поля должны существовать в карточке, закреплённые значения должны быть
допустимы и относиться к скрытым полям, итоговые границы сумм — согласованы.
...
останавливают запуск и seed до записи данных. Существующие раунды используют
свои сохранённые снимки, включая историческую операцию `cash_deposit`.

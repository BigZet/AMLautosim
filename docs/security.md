...
ведущего: кнопка «Показать все ники» на вкладке «Экран для зала» в админке и
параметр `?reveal=true` у API, требующий административной сессии. Аноним получает
`401`, участник — `403`. После перезагрузки состояние снова безопасное.

В интерфейсе участника кнопки раскрытия нет: свою строку он находит по
`is_current_user`, не раскрывая ничьих имен.

...
|---|---|---|---:|
| train | salary | absent | 12331 |
| train | salary | no_reference | 237 |
| train | salary | payroll_registry | 312 |
| train | salary | service_contract | 315 |
| train | cash | absent | 5153 |
| train | cash | present | 8042 |
| validation | salary | absent | 2934 |
| validation | salary | no_reference | 0 |
| validation | salary | payroll_registry | 0 |
| validation | salary | service_contract | 0 |
| validation | cash | absent | 0 |
| validation | cash | present | 2934 |
| test | salary | absent | 3871 |
| test | salary | no_reference | 0 |
| test | salary | payroll_registry | 0 |
| test | salary | service_contract | 0 |
| test | cash | absent | 3871 |
| test | cash | present | 0 |

Совпадение направления парного изменения не означает совпадения его величины. Расхождения изменений более 5 баллов:

- party: модель +20.21, рубрика +32.84 балла. Нужен отдельный разбор перед включением этого поведения в игру.
- salary: модель -0.94, рубрика -11.25 балла. Нужен отдельный разбор перед включением этого поведения в игру.

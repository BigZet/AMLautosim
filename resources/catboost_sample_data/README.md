...
> Deferred tooling: retained for future experiments, excluded from the server image.
> No CatBoost model is trained or used by the current FastAPI + NiceGUI application.

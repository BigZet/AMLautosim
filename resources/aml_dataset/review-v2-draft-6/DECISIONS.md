...
Несколько текущих покупок дают небольшой суммарный эффект: максимум 3 балла, с учётом количества и доли расходов. Одна покупка не даёт снижения. Три покупки по 2 000 руб. при обороте 400 000 снижают оценку на 0.9 балла. Порог и максимальный размер эффекта пока предложены для реализации пожелания «не сильно».

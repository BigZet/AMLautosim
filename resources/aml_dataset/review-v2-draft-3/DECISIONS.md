...
Предложение для текущей зарплаты: реестр снижает сумму вкладов на 40%, договор услуг — на 20%, отсутствие назначения — на 0%. Снижение применяется один раз. Коэффициенты и различие оснований требуют согласования.
